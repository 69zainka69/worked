    ...
    <div class="content-wrap">
        <div class="container">
            <div class="row">
                ...
                <p>Приглашаем к сотрудничеству. Связывайтесь с нами, мы будем рады ответить на ваши вопросы.</p> 
                <form role="form" method="POST" action="">
                    @csrf
                    <div class="form-group">
                      <label for="fullname">ФИО</label>
                      <input type="text" class="form-control" id="fullname" aria-describedby="emailHelp" placeholder="Ф.И.О">
                    </div>
                    <div class="form-group">
                    ...
                    <button style="background-color:rgb(6 184 11);" type="submit" class="btn btn-primary">Оставить заявку</button>
                  </form>
                ...
                <form id="directionform1_b20wn_0" action="https://maps.google.com/maps" method="get" target="_blank" onsubmit="javascript:googlemap1_b20wn_0.DirectionMarkersubmit(this);return false;" class="mapdirform" style="text-align: center; margin-bottom: 10px;">
                    ...
                    <button  value="Проложить маршрут" class="fas fa-map-marker-alt" type="submit"> Проложить маршрут</button>
                   </form>
                </div>
            </div>
        </div>
