@extends('layout.main')
@section('lang', 'ru')
@section('title', 'Отзывы о компании Staffplex')
@section('description', 'Staffplex - отзывы о компании')
@section('keywords', 'Staffplex, отзывы')
...
<meta property="og:locale" content="ru_RU" />
	...
	<meta property="og:title" content="Отзывы - Staffplex" />
    ...
    <div class="content-wrap">
        <div class="container">
                ...
                <div class="col-sm-8">
                    <div class="img-subsco">
                        <div class="icon-play-y">
                            <a href="https://www.youtube.com/watch?v=QFPMr_jXthQ" class="popup-youtube"><i style="font-size:20px; padding-top:20px; color:black;" class="fas fa-play-circle">Смотреть видеоотзыв</i></a>
                        </div>
                    </div>
                      </div>
                <div class="col-sm-2">
                   <img class="round" src="/images/znimok-ekrana-2020-12-25-141240-e1608900636893.png" />
                </div>
            </div>
            ...
            <div style="padding-top:20px;" class="row">
                ...
                <div class="col-sm-8">
                    <div class="icon-play-y">
                        <a href="https://www.youtube.com/watch?v=S0RKtTFEVgk" class="popup-youtube"><i style="font-size:20px; color:black;" class="fas fa-play-circle">Смотреть видеоотзыв</i></a>
                    </div>
                  </div>
                <div class="col-sm-2">
                   <img class="round" src="/images/znimok-ekrana-2020-12-25-141451-e1608900657702.png" />
                </div>
            </div>
