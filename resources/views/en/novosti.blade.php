@extends('layout.en')
@section('lang', 'en')
@section('title', 'News - Staffplex')
@section('description', 'News - Staffplex')
@section('keywords', 'Staffplex, News')
...
<meta property="og:locale" content="en_GB" />
	...
	<meta property="og:title" content="News - Staffplex" />
	<meta property="og:url" content="https://staffplex.de/en/news" />
        ...
        <div class="item">
            ...
            <div class="container d-flex align-items-center h-center">
                <div class="wrap-caption">
                    <h1 class="caption-heading text-white">Who will be allowed to enter Germany during a pandemic</h1>
...
<div class="section bg-gray-light">
    <div class="content-wrap">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2>Who will be allowed to enter Germany during a pandemic</h2>
