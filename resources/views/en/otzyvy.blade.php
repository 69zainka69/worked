@extends('layout.en')
@section('lang', 'en')
@section('title', 'Reviews Staffplex')
@section('description', 'Staffplex - Reviews')
@section('keywords', 'Staffplex, Reviews')
...
<meta property="og:locale" content="en_GB" />
	...
	<meta property="og:url" content="https://staffplex.de/en/reviews" />
        ...
        <div class="item">
            ...
            <div class="container d-flex align-items-center h-center">
                <div class="wrap-caption">
                    <h1 class="caption-heading text-white">Reviews</h1>
    ...
    <div class="content-wrap">
        <div class="container">
                ...
                <div class="col-sm-8">
                    <div class="img-subsco">
                        <div class="icon-play-y">
                            <a href="https://www.youtube.com/watch?v=mMC7Bht96-g" class="popup-youtube"><i style="font-size:20px; padding-top:20px; color:black;" class="fas fa-play-circle">Смотреть видеоотзыв</i></a>
                        </div>
                    </div>
                      </div>
                <div class="col-sm-2">
            ...
            <div style="padding-top:20px;" class="row">
                ...
                <div class="col-sm-8">
                    <div class="icon-play-y">
                        <a href="https://www.youtube.com/watch?v=cu_f6c6nt7s" class="popup-youtube"><i style="font-size:20px; color:black;" class="fas fa-play-circle">Смотреть видеоотзыв</i></a>
                    </div>
                  </div>
                <div class="col-sm-2">
