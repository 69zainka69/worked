@extends('layout.en')
@section('lang', 'en')
@section('title', 'Contacts - Staffplex')
@section('description', 'Staffplex - Contacts')
@section('keywords', 'Staffplex, Contacts')
        ...
        <div class="item">
            ...
            <div class="container d-flex align-items-center h-center">
                <div class="wrap-caption">
                    <h1 class="caption-heading text-white">Contacts Staffplex</h1>
    ...
    <div class="content-wrap">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-5">
                <h2>Contact us</h2>
                <p>We invite you to cooperation. Contact us, we will be happy to answer your questions.</p> 
                <form role="form" method="POST" action="">
                    ...
                    <button style="background-color:rgb(6 184 11);" type="submit" class="btn btn-primary">Submit your application</button>
                  </form>
                ...
                <form id="directionform1_b20wn_0" action="https://maps.google.com/maps" method="get" target="_blank" onsubmit="javascript:googlemap1_b20wn_0.DirectionMarkersubmit(this);return false;" class="mapdirform" style="text-align: center; margin-bottom: 10px;">
                    ...
                    <button  value="Get directions" class="fas fa-map-marker-alt" type="submit"> Get directions</button>
                   </form>
                </div>
            </div>
        </div>
