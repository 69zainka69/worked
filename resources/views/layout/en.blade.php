			...
			<div style="padding-left: auto; padding-right:auto;" class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="navbar-nav">
					<li class="nav-item dropdown">
						...
						<div style="left:17%; top: 120%;" class="dropdown-menu">
							<a class="dropdown-item" href="/en/about-company">About company</a>
							  <a class="dropdown-item" href="/en/about-company/work-at-staffplex">Work at Staffplex</a>
						</div>
					</li>

				<li class="nav-item active">
				  <a class="nav-link" href="/en/our-vacancies">Our vacancies</a>
				</li>
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						Services
					...
					<div style="bottom: -69px;" class="dropdown-menu">
						<a class="dropdown-item" href="/en/service/manufactured-by-van-der-elst-visa">Manufactured by Van Der Elst visa</a>
					</div>
				</li>
				<li class="nav-item active">
				  <a class="nav-link" href="/en/youtube">Youtube</a>
				</li>
				<a class="nav-link biglogos" href="/"><span><img width="150" src="/images/logo.png" alt="Staffplex"></span></a>
				<li class="nav-item active">
					<a class="nav-link" href="/en/for-the-employer">For the employer</a>
				  </li>
				...
				<div class="row">
					...
					<div class="col-sm-6 col-md-6 col-lg-4">
						<div class="footer-item">
							...
							<p>We help to close many issues: we select high-quality personnel, we are responsible for all registrations and legal issues, if necessary, we find housing near the facilities, we provide working cars. The customer receives a ready-made specialist at his facility.</p>
					...
					<div class="col-sm-12 col-md-12 col-lg-4">
						<div class="footer-item">
							...
							<div class="row">
								<div class="col-md-12">
									<ul class="list">
										<li><a href="/en/about-company" title="Home">About company</a></li>
										<li><a href="/en/our-vacancies" title="Pages">Our vacancies</a></li>
										<li><a href="/en/news" title="Blog">News</a></li>
										<li><a href="/en/privacy-policy" title="Contact">Privacy Policy</a></li>
										<li><a  target="_blank" href="/docs/Cetryfikat_Agencja_Pracy.pdf" title="Privacy">Certificate</a></li>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12 col-md-12 col-lg-12">
						<p class="mt-3 text-center">2021 © “Staffplex”. All rights reserved</p> 
					</div>
				</div>
			</div>
		</div>
