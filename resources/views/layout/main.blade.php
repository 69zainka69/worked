			...
			<div style="padding-left: auto; padding-right:auto;" class="collapse navbar-collapse" id="navbarCollapse">
			  <ul class="navbar-nav mr-auto">
				<li class="nav-item active">
						...
						<div style="left:17%;" class="dropdown-menu">
				...
				<li class="nav-item active">
				  <a class="nav-link" href="/youtube">Ютуб галерея</a>
				</li>
							...
							<div class="row">
								<div class="col-md-12">
									<ul class="list">
										...
										<li><a  target="_blank" href="/docs/Cetryfikat_Agencja_Pracy.pdf" title="Privacy">Сертификат</a></li>
