@extends('layout.de')
@section('lang', 'de')
@section('title', 'Unsere offenen Stellen')
@section('description', 'Unsere offenen Stellen')
@section('keywords', 'Unsere offenen Stellen')
...
<meta property="og:locale" content="de_DE" />
	...
	<meta property="og:title" content="Unsere offenen Stellen - Staffplex" />
...
@section('EN', '/en/our-vacancies')
@section('RU', '/nashi-vakansii')
@section('DE', '/de/unsere-offenen-stellen')
        ...
        <div class="item">
            ...
            <div class="container d-flex align-items-center h-center">
                <div class="wrap-caption">
                    <h1 class="caption-heading text-white">Unsere offenen Stellen</h1>
                </div>   
            </div>
        </div>
    </div>
...
<div class="section bg-gray-light">
    <div class="content-wrap">
        <div class="container">
            <h2 style="text-align:center;">Unsere offenen Stellen Staffplex</h2>
            <div class="row mobilestab">
                    ...
                    <div class="card col-sm-6 col-md-4" style="width: 18rem;">
                        ...
                        <div class="card-body">
                          <h5 class="card-title">Spezialist Maurer-Klinker</h5>
                          <p class="card-text">
                        ...
                        <span class="fas fa-home">
                          Unterkunft nicht inbegriffen
                           ...
                           <script data-b24-form="click/2/gs02zg" data-skip-moving="true">
                            (function(w,d,u){
                                    var s=d.createElement('script');s.async=true;s.src=u+'?'+(Date.now()/180000|0);
                                    var h=d.getElementsByTagName('script')[0];h.parentNode.insertBefore(s,h);
                            })(window,document,'https://cdn-ru.bitrix24.ru/b16941588/crm/form/loader_2.js');
                    </script>
                    
                           <button>Schreiben Sie im Chat</button>
                      ...
                      <div class="card col-sm-6 col-md-4" style="width: 18rem;">
                        ...
                        <div class="card-body">
                          <h5 class="card-title">Fassadenspezialist</h5>
                          <p class="card-text">
                        <span class="fas fa-map-marker-alt">
                          Bundesland Sachsen, Spelle
                        </span><br>
                        <span class="fas fa-money-bill-wave">
                          12 € pro stunde
                        </span><br>
                      ...
                      <div class="card col-sm-6 col-md-4" style="width: 18rem;">
                        ...
                        <div class="card-body">
                          <h5 class="card-title">Spezialist Maler-Stuckateur</h5>
                          <p class="card-text">
                        <span class="fas fa-map-marker-alt">
                ...
                <div style="padding-top:30px;" class="row mobilestab">
                <div class="card col-sm-6 col-md-4" style="width: 18rem;">
                    <img class="card-img-top" src="/images/glazurnik-zlecenia-oferty-a.jpg" alt="Специалист плиточник">
                    <div class="card-body">
                      <h5 class="card-title">Spezialist Fliesenleger</h5>
                      <p class="card-text">
                    <span class="fas fa-map-marker-alt">
                  ...
                  <div class="card col-sm-6 col-md-4" style="width: 18rem;">
                    ...
                    <div class="card-body">
                      <h5 class="card-title">Spezialist Maurer-Silikat-Blöcke</h5>
                      <p class="card-text">
                    <span class="fas fa-map-marker-alt">
                  ...
                  <div class="card col-sm-6 col-md-4  " style="width: 18rem;">
                    ...
                    <div class="card-body">
                      <h5 class="card-title">Klempnerspezialist</h5>
                      <p class="card-text">
                    <span class="fas fa-map-marker-alt">
                      Bundesland Sachsen, Lunne
                    </span><br>
                    <span class="fas fa-money-bill-wave">
                      12 € pro stunde
                    </span><br>
